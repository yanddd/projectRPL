...
$routes->get('/sepatu/cek/(:segment)', 'Sepatu::cek/$1');
$routes->get('/sepatu/clear/(:segment)', 'Sepatu::clear/$1');
$routes->get('/sepatu/beli/(:segment)', 'Sepatu::beli/$1');
$routes->get('/sepatu/beliKeranjang/(:segment)', 'Sepatu::beliKeranjang/$1');
